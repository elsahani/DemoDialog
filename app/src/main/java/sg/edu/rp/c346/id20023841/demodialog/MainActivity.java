    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btnDemo3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                AlertDialog.Builder myBuilder = new AlertDialog.Builder(MainActivity.this);
                myBuilder.setView(viewDialog); //Set the view of the diaog
                myBuilder.setTitle("Demo 3-Text Input Diaog");
        ...
        btnEx3.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final EditText etnum1 = viewDialog.findViewById(R.id.editTextInput1);
                final EditText etnum2 = viewDialog.findViewById(R.id.editTextInput2);
                ...
                myBuilder.setPositiveButton("OK", new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        int numone = Integer.parseInt(etnum1.getText().toString());
                        int numtwo = Integer.parseInt(etnum2.getText().toString());
                        int total = numone + numtwo;
                        String msg = "The sum is " + total;
                        tvEx3.setText(msg);
                    }
                });
                myBuilder.setNegativeButton("CANCEL", null);
